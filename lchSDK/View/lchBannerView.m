...
@interface lchBannerView () <UIScrollViewDelegate>
...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _pageControl.pageIndicatorTintColor =  [UIColor colorWithWhite:230/255.0 alpha:0.5];
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithWhite:255/255.0 alpha:0.9];
...
- (void)clickImgView:(UIGestureRecognizer *)sender {
    ...
    NSString *title = self.titleA[_curIndex];
    NSString *url = self.urlA[_curIndex];
    self.imgViewSelectBlock(title,url);
}
